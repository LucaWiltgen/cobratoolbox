...
if [ "$ARCH" == "Linux" ]; then
    ...
    echo " -- new path --"
    nohup "C:\\Windows\\System32\\cmd.exe" /c "SET PATH=C:\Windows\system32;C:\Windows;C:\Windows\System32\Wbem;C:\Program Files\Git\cmd;C:\Program Files\Git\mingw64\bin;C:\Program Files\Git\usr\bin;C:\Program Files (x86)\Windows Kits\10\Windows Performance Toolkit\"
    "C:\\Windows\\System32\\cmd.exe" /c "echo %PATH%"
