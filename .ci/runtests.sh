...
if [ "$ARCH" == "Linux" ]; then
    ...
    nohup "/cygdrive/c/Program Files/MATLAB/R2016b/bin/matlab" -useStartupFolderPref -logfile output.log -wait -r "system('which git'); system('git --version'); system('whoami'); system('pwd'); initCobraToolbox" & PID=$!
